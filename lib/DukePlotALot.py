...
class plotter():
    ...
    def __init__(self, hist = [], sig = [], hist_axis = [], data_hist = None, data = False, cms = 13, lumi = 42000, style = None, **kwargs):
        ## style variables
        # self._style                = style
        ## BG histograms
        self._hist                 = hist
        ...
        if style==None:
            self._Style_cont = sc.style_container(kwargs)
        else:
...
#        self.cms_text_alignment = AddAlign
    ...
    def DrawRoot(self):
        ...
        deco=rooLib.CmsDecoration(sc_obj=self._Style_cont ,lumiText=lumitext ,extraText=self._Style_cont.Get_additional_text(), pad=self._mainPad)
        deco.Draw()
        self._canvas.Update()
